...
from aci.common.openai_clients import get_default_cli_client # Import the factory helper
...
# get_default_cli_client() uses CLI_OPENAI_API_KEY (or falls back to SERVER_OPENAI_API_KEY)
openai_client = get_default_cli_client()
